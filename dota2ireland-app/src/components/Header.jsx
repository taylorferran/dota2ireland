      ...
      <div className="flex flex-1 justify-end items-center gap-6 md:gap-8">
        ...
        <div className="flex gap-2">
          <a 
            ...
            className="flex max-w-xs cursor-pointer items-center justify-center overflow-hidden rounded-full h-10 w-10 bg-white/10 text-white hover:bg-white/20 transition-colors"
